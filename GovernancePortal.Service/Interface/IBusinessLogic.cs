...
{
    Task<bool> SendNotificationToSingleUser(string notificationMessage, string redirectUrl, string userId, CancellationToken token);
    Task<bool> SendNotificationToBulkUser(string notificationMessage, string redirectUrl,  List<string> userIds, CancellationToken token);
