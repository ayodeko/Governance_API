...
{
    public class MeetingRepoDeprDepr : GenericRepo<Meeting>, IMeetingsRepo_depr
        
    {
        public PortalContext _db { get { return _context as PortalContext; } }
        public MeetingRepoDeprDepr(PortalContext db) : base(db)
        {
        ...
        {
            return _context.Set<Meeting>().Where(x => x.CompanyId == companyId && x.Title.Contains(searchString));
        }
