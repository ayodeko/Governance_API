...
namespace GovernancePortal.EF.Migrations
{
    ...
    [Migration("20230222135201_add-IsUploadedMeeting-to-Meeting")]
    partial class addIsUploadedMeetingtoMeeting
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GovernancePortal.Core.Meetings.Meeting", b =>
                {
                    ...
                    b.Property<bool>("isMinutesUploaded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GovernancePortal.Core.Meetings.StandAloneMinute", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GovernancePortal.Core.Meetings.StandAloneMinute", b =>
                {
                    ...
                    b.HasOne("GovernancePortal.Core.Meetings.Meeting", null)
                        .WithOne("StandAloneMinute")
                        .HasForeignKey("GovernancePortal.Core.Meetings.StandAloneMinute", "MeetingId");
